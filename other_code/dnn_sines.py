...
from tensorflow.python.keras.layers import Dense, Dropout, Activation, Flatten, Conv2D, MaxPooling2D, TimeDistributed, LSTM, RNN
import numpy as np
...
NAME = "dnn_basic_sines-{}".format(int(time.time()))
